...
(function() {
  ...
  ANEF.i18n.register('fr', {
    ...
    'toolbar.interview_from_ph': 'Entretien du : jj/mm/aaaa',
    'toolbar.interview_to_ph': 'au : jj/mm/aaaa',
    'toolbar.interview_date_tip': 'Entretien entre deux dates (une seule suffit)',
